...
[Docker](https://www.docker.io/) 是 PaaS 提供商 [dotCloud](https://www.dotcloud.com/) 开源的一个基于 LXC 的高级容器引擎，
[源代码](https://github.com/dotcloud/docker)托管在 Github 上, 基于go语言并遵从Apache2.0协议开源。
Docker近期非常火热，无论是从 github 上的代码活跃度，还是Redhat在[RHEL6.5中集成对Docker的支持](https://developerblog.redhat.com/2013/11/26/rhel6-5-ga/), 就连 Google 家的 Compute Engine 也[支持 docker 在其之上运行](https://googlecloudplatform.blogspot.com/2013/12/google-compute-engine-is-now-generally-available.html), 最近百度也用 Docker 作为[其PaaS的基础](blog.docker.io/2013/12/baidu-using-docker-for-its-paas/‎)(不知道规模多大)。
...
![container vs VM](/static/images/docker_vm.jpg)
...
![docker-filesystems-generic](/static/images/docker-filesystems-generic.png)
...
![docker-filesystems-multiroot](/static/images/docker-filesystems-multiroot.png)
...
![docker-filesystems-multilayer](/static/images/docker-filesystems-multilayer.png)
...
![docker-filesystems-debian](/static/images/docker-filesystems-debian.png)
![docker-filesystems-debianrw](/static/images/docker-filesystems-debianrw.png)
...
![docker-filesystems-busyboxrw](/static/images/docker-filesystems-busyboxrw.png)
